  ...
  render() {
    return (
      <div className="flex-col w-5/6 min-h-screen m-auto mt-24 text-primary md:w-2/3 bg-primary">
          ...
          <div className="flex flex-col w-full mx-auto mt-16 mb-20 lg:flex-row ">
            <div className="w-full p-2 mx-3 my-5 text-md lg:w-3/4">
              ...
              <p className="w-full mx-auto text-sm leading-relaxed md:text-md">
                ...
                included contact form to send an email to the restaurant owner.
                I also obtained web traffic data such as number of visitors
                trend and general locations, which helped the restaurant owner
        ...
        <div className="mx-auto mt-12 space-y-2 row">
          ...
          <div className="flex flex-col w-full mx-auto mt-16 mb-20 lg:flex-row ">
            <div className="w-full p-2 mx-3 my-5 text-md lg:w-3/4">
              ...
              <p className="w-full mx-auto text-sm leading-relaxed md:text-md">
                Parfaitlyme is a demo webiste to show recipes designed using MVT
                framwork (Django), and React for the frontend. The recipe data
                is loaded to SQLite database, and the website is managed with
                Django admin. Frontend is developed with React framework and
                Tailwind CSS. Recipe page categorizes and displays recipes with
                infinite scroll.
              </p>
            </div>
            <div className="w-full p-2 mx-3 my-5 lg:w-1/4">
          ...
          <div className="flex flex-col w-full mx-auto mt-16 mb-20 lg:flex-row ">
            <div className="w-full p-2 mx-3 my-5 text-md lg:w-3/4">
              ...
              <p className="w-full mx-auto text-sm leading-relaxed md:text-md">
                ...
                extracted from house sale posts on Zillow website. Web scraping
                code obtain data such as price, size, and number of rooms, which
                are stored in SQLite database. This database can be graphed to
                display the trend over time as well as scatter or bar graph of
                selected date showing price vs sqft, average price with respect
                to number of rooms or by location.
              </p>
            </div>
            <div className="w-full p-2 mx-3 my-5 lg:w-1/4">
              <h3 className="h-6 my-2 lg:text-xl md:text-lg text-md">
        ...
        <div className="mx-auto mt-12 space-y-2 row">
          <div className="inline-flex w-full h-8 m-4">
            <h2 className="text-lg lg:text-2xl md:text-xl">Accounting Book</h2>
          </div>
          <div className="w-full mx-auto mt-8 md:w-2/3">
            <AwesomeSlider
              animation="cubeAnimation"
          ...
          <div className="flex flex-col w-full mx-auto mt-16 mb-20 lg:flex-row ">
            <div className="w-full p-2 mx-3 my-5 text-md lg:w-3/4">
              ...
              <p className="w-full mx-auto text-sm leading-relaxed md:text-md">
                ...
                allows the user to show monthly spending, and also edit category
                on their own, if incorrectly categorized. Also, all the
                transactions can be saved after filtering/categorizing into one
                excel file for each month. Yearly, or long-term, spending data
                can be presented with user-defined month range with saved
                monthly excel files.
              </p>
            </div>
            <div className="w-full p-2 mx-3 my-5 lg:w-1/4">
        ...
        <div className="mx-auto mt-12 space-y-2 row">
          ...
          <div className="flex flex-col w-full mx-auto mt-16 mb-20 lg:flex-row ">
            <div className="w-full p-2 mx-3 my-5 text-md lg:w-3/4">
              ...
              <p className="w-full mx-auto text-sm leading-relaxed md:text-md">
                The software I developed analyzes Atomic Force Microscopic (AFM)
                images of CarbonNano Tube (CNT). The goal of this project was to
                quantify amount of CNT film on samples or surface coverage (=
                CNT area/total area) from AFM images. The image is processed
                with multiple imaging techniques such as thresholding, blurring,
                filtering, object-detection. Then, the procssed image is used to
                calculate the surface coverage and uniformity of the CNT
                samples. The software also has GUI that allows users to load
                folder, go through images in that folder, and save processed
                images.
              </p>
            </div>
            <div className="w-full p-2 mx-3 my-5 lg:w-1/4">
          ...
          <div className="flex flex-col w-full mx-auto mt-16 mb-20 lg:flex-row ">
            <div className="w-full p-2 mx-3 my-5 text-md lg:w-3/4">
              ...
              <p className="w-full mx-auto text-sm leading-relaxed md:text-md">
                ...
                panels from photographic images, and calculates uniformity based
                on grey-scale values. For this project, another program works in
                a similar manner for microscopic images. For both applications,
                the code generates excel files that combine the data from
                multiple images to allow batch processing.
              </p>
            </div>
            <div className="w-full p-2 mx-3 my-5 lg:w-1/4">
              <h3 className="h-6 my-2 lg:text-xl md:text-lg text-md">

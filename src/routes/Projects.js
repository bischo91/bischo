...
import parfaitlyme_1 from "../images/parfaitlyme/parfaitlyme_1.jpg";
import parfaitlyme_2 from "../images/parfaitlyme/parfaitlyme_2.jpg";
import parfaitlyme_3 from "../images/parfaitlyme/parfaitlyme_3.jpg";
  ...
  render() {
    return (
      <div className="text-primary flex-col w-5/6 m-auto mt-24 min-h-screen bg-primary">
        ...
        <div className="row space-y-2 mt-4 mx-auto lg:w-2/3">
